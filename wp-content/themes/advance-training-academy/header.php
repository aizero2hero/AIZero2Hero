        ...
        <div class="col-lg-3 col-md-4 logo-box py-4 px-5">
          <div class="logo text-md-start text-center">
            ...
            if ( $description || is_customize_preview() ) :
              ?>
              <?php if( get_theme_mod('advance_training_academy_tagline',true) != ''){ ?>
              ...
              <div class="col-lg-8 col-md-8 align-self-center">
                <?php if( get_theme_mod('advance_training_academy_mail_address') != '') {?>
                  <span class="contact email">
                    <a href="mailto:<?php echo esc_attr(get_theme_mod('advance_training_academy_mail_address')); ?>"><i class="fas fa-envelope me-2"></i><?php echo esc_html(get_theme_mod('advance_training_academy_mail_address')); ?><span class="screen-reader-text"><?php echo esc_html(get_theme_mod('advance_training_academy_mail_address')); ?></span></a>
                  </span>
                <?php }?>
                <?php if( get_theme_mod('advance_training_academy_phoneno') != '') {?>
                  <span class="contact">
                    <a href="tel:<?php echo esc_attr(get_theme_mod('advance_training_academy_phoneno')); ?>"><i class="fas fa-phone me-2"></i><?php echo esc_html(get_theme_mod('advance_training_academy_phoneno')); ?><span class="screen-reader-text"><?php echo esc_html(get_theme_mod('advance_training_academy_phoneno')); ?></span></a>
                  </span>
                <?php }?>
              </div>
              <div class="col-lg-4 col-md-4 align-self-center text-center">
                <div class="social-icons d-md-inline-block">
                  <?php if(get_theme_mod('advance_training_academy_facebook_url') != ''){?>
                    <a href="<?php echo esc_url(get_theme_mod('advance_training_academy_facebook_url')); ?>"><i class="fab fa-facebook-f"></i><span class="screen-reader-text"><?php echo esc_html('Facebook', 'advance-training-academy'); ?></span></a>
                  <?php }?>
                  <?php if(get_theme_mod('advance_training_academy_twitter_url') != ''){?>
                    <a href="<?php echo esc_url(get_theme_mod('advance_training_academy_twitter_url')); ?>"><i class="fab fa-twitter"></i><span class="screen-reader-text"><?php echo esc_html('Twitter', 'advance-training-academy'); ?></span></a>
                  <?php }?>
                  <?php if(get_theme_mod('advance_training_academy_instagram_url') != ''){?>
                    <a href="<?php echo esc_url(get_theme_mod('advance_training_academy_instagram_url')); ?>"><i class="fab fa-instagram"></i><span class="screen-reader-text"><?php echo esc_html('Instagram', 'advance-training-academy'); ?></span></a>
                  <?php }?>
                  <?php if(get_theme_mod('advance_training_academy_linkedin_url') != ''){?>
                    <a href="<?php echo esc_url(get_theme_mod('advance_training_academy_linkedin_url')); ?>"><i class="fab fa-linkedin"></i><span class="screen-reader-text"><?php echo esc_html('Linkedin', 'advance-training-academy'); ?></span></a>
                  <?php }?>
                  <?php if(get_theme_mod('advance_training_academy_youtube_url') != ''){?>
                    <a href="<?php echo esc_url(get_theme_mod('advance_training_academy_youtube_url')); ?>"><i class="fab fa-youtube"></i><span class="screen-reader-text"><?php echo esc_html('Youtube', 'advance-training-academy'); ?></span></a>
                  <?php }?>
                </div>
              </div>
            </div>
