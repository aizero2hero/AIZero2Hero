      ...
      <div class="main-content-box">
        ...
        <div class="metabox my-3 text-start">
          <?php if( get_theme_mod( 'advance_training_academy_single_post_date_hide',true) != '') { ?>
            <span class="entry-date me-2"><i class="fa fa-calendar me-1"></i><a href="<?php echo esc_url( get_day_link( $archive_year, $archive_month, $archive_day)); ?>"><?php echo esc_html( get_the_date() ); ?><span class="screen-reader-text"><?php echo esc_html( get_the_date() ); ?></span></a></span><span class="me-1"><?php echo esc_html( get_theme_mod('advance_training_academy_single_post_meta_seperator','|') ); ?></span>
          <?php } ?>
          <?php if( get_theme_mod( 'advance_training_academy_single_post_author_hide',true) != '') { ?>
            <span class="entry-author me-2"><i class="fa fa-user me-2"></i><a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' )) ); ?>"><?php the_author(); ?><span class="screen-reader-text"><?php the_author(); ?></span></a></span><span class="me-1"><?php echo esc_html( get_theme_mod('advance_training_academy_single_post_meta_seperator','|') ); ?></span>
          <?php } ?>
          <?php if( get_theme_mod( 'advance_training_academy_single_post_comment_hide',true) != '') { ?>
            <span class="entry-comments me-2"><i class="fas fa-comments me-1"></i><?php comments_number( __('0 Comments','advance-training-academy'), __('0 Comments','advance-training-academy'), __('% Comments','advance-training-academy') ); ?></span>
          <?php } ?>
        </div>
