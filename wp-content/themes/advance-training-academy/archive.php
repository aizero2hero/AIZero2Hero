...
<main role="main" id="maincontent" class="our-services py-5">
    <div class="innerlightbox">
        <div class="container">
            <?php
            $advance_training_academy_left_right = get_theme_mod( 'advance_training_academy_layout_options','Grid Layout');
                            ...
                            <div class="navigation">
                                <?php
                                    ...
                                    the_posts_pagination( array(
                                        ...
                                        'before_page_number' => '<span class="meta-nav text-uppercase p-2 screen-reader-text">' . __( 'Page', 'advance-training-academy' ) . ' </span>',
                                    ) );
                                ?>
                            </div> 
                        <?php } ?>
            ...
            <?php }else if($advance_training_academy_left_right == 'Three Columns'){ ?>
                <div class="row">
                    ...
                    <div id="post-<?php the_ID(); ?>" <?php post_class('col-lg-4 col-md-8'); ?>>
                        <?php
                            the_archive_title( '<h1 class="page-title">', '</h1>' );
                            the_archive_description( '<div class="taxonomy-description">', '</div>' );
                        ?>
