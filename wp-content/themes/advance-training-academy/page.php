        ...
        if($advance_training_academy_left_right == 'Left Sidebar'){ ?>
            <div class="row">
                ...
                <div class="col-lg-8 col-md-8 left-sidebar-page background-img-skin">
                    <?php if (get_theme_mod('advance_training_academy_single_page_breadcrumb',true) != ''){ ?>
                    ...
                    <?php
                        ...
                        wp_link_pages( array(
                            'before'      => '<div class="page-links mb-5"><span class="page-links-title">' . __( 'Pages:', 'advance-training-academy' ) . '</span>',
                            'after'       => '</div>',
                            'link_before' => '<span>',
                            'link_after'  => '</span>',
                            'pagelink'    => '<span class="screen-reader-text">' . __( 'Page', 'advance-training-academy' ) . ' </span>%',
