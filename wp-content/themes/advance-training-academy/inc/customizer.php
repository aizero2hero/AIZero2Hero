...
function advance_training_academy_customize_register($wp_customize) {
    ...
    $wp_customize->add_setting( 'advance_training_academy_loader_background_color_first', array(
  	...
  	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'advance_training_academy_loader_background_color_first', array(
  		'label' => __('Background Color for Preloader 1', 'advance-training-academy'),
	    'section' => 'advance_training_academy_left_right',
	    'settings' => 'advance_training_academy_loader_background_color_first',
  	)));

    $wp_customize->add_setting( 'advance_training_academy_loader_background_color_second', array(
	    'default' => '#fff',
	    'sanitize_callback' => 'sanitize_hex_color'
  	));
  	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'advance_training_academy_loader_background_color_second', array(
  		'label' => __('Background Color for Preloader 2', 'advance-training-academy'),
	    'section' => 'advance_training_academy_left_right',
	    'settings' => 'advance_training_academy_loader_background_color_second',
  	)));
	...
	$wp_customize->add_control('advance_training_academy_layout_options',array(
		'type'           => 'radio',
		'label'          => __('Blog Page Layouts', 'advance-training-academy'),
		'section'        => 'advance_training_academy_left_right',
		'choices'        => array(
	...
	// Button
	$wp_customize->add_section( 'advance_training_academy_theme_button', array(
		'title' => __('Button Option','advance-training-academy'),
		'panel' => 'advance_training_academy_panel_id',
	));

	$wp_customize->add_setting('advance_training_academy_button_padding_top_bottom',array(
		'default'=> '',
		'sanitize_callback'	=> 'advance_training_academy_sanitize_float',
	));
	$wp_customize->add_control('advance_training_academy_button_padding_top_bottom',array(
		'label'	=> __('Top and Bottom Padding','advance-training-academy'),
		'input_attrs' => array(
            'step'             => 1,
			'min'              => 0,
			'max'              => 50,
        ),
		'section'=> 'advance_training_academy_theme_button',
		'type'=> 'number'
	));

	$wp_customize->add_setting('advance_training_academy_button_padding_left_right',array(
		'default'=> '',
		'sanitize_callback'	=> 'advance_training_academy_sanitize_float',
	));
	$wp_customize->add_control('advance_training_academy_button_padding_left_right',array(
		'label'	=> __('Left and Right Padding','advance-training-academy'),
		'input_attrs' => array(
            'step'             => 1,
			'min'              => 0,
			'max'              => 50,
	...
	$wp_customize->add_setting( 'advance_training_academy_button_border_radius', array(
		'default'=> '',
		'sanitize_callback'	=> 'advance_training_academy_sanitize_float',
	) );
	$wp_customize->add_control( 'advance_training_academy_button_border_radius', array(
		'label'       => esc_html__( 'Button Border Radius','advance-training-academy' ),
		'section'     => 'advance_training_academy_theme_button',
		'type'        => 'number',
		'input_attrs' => array(
			'step'             => 1,
	...
	$wp_customize->add_section('advance_training_academy_blog_post',array(
		'title'	=> __('Blog Page Settings','advance-training-academy'),
		'panel' => 'advance_training_academy_panel_id',
	));	
	...
	$wp_customize->add_section('advance_training_academy_single_post',array(
		'title'	=> __('Single Post Setting','advance-training-academy'),
		'panel' => 'advance_training_academy_panel_id',
	));
		...
		$manager->add_section(
			new Advance_Training_Academy_Customize_Section_Pro(
				...
				array(
					...
					'pro_text' => esc_html__('GO PRO', 'advance-training-academy'),
